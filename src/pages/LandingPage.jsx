...
export default function LandingPage({ onOpenGazetteStudio }) {
  ...
  // Mode Toggle: 'signup', 'login', 'forgot'
              ...
              {authMode === 'forgot' ? (
                forgotStep === 'request' ? (
                  ...
                  <form onSubmit={handleForgotSubmit} className="space-y-3.5">
                    ...
                    <div>
                      <label className="block text-[10px] font-bold uppercase text-secondary mb-1">New Password</label>
                      <div className="relative">
                        <input
                          type="password"
                          value={newPassword}
                ...
                <form onSubmit={handleQuickAuth} className="space-y-3.5">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-[10px] font-bold uppercase text-secondary">Password</label>
                      {authMode === 'login' && (
                        <button
                          type="button"
                  ...
                  {authMode === 'signup' && (
                    <div>
                      ...
                      <p className="text-[10px] text-muted font-mono mt-1">
                        *If left blank, an anonymous handle (e.g. Backbencher #402) is assigned automatically based on your email.
                      </p>
                    </div>
                  )}
